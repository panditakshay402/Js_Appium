...
exports.V6_BROADCAST_IP = exports.V4_BROADCAST_IP = void 0;
...
function fetchInterfaces(family = null) {
    ...
    const ifaces = Object.values(node_os_1.default.networkInterfaces()).filter(Boolean);
    return ifaces
        .flat()
        .filter((info) => !familyValue || familyValue.includes(info.family));
}
/**
