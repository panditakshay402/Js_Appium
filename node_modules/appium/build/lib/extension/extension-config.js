...
class ExtensionConfig {
    ...
    async _resolveExtension(extName) {
        ...
        try {
            ...
            throw new ReferenceError(`Could not find the ${this.extensionType} installed at ${moduleRoot}: ${e.message}`, { cause: e });
        }
