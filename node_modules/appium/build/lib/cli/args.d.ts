 ...
 */
export declare const getExtensionArgs: (() => Record<ExtensionType, Record<CliExtensionSubcommand, ArgumentDefinitions>>) & {
    cache: Map<unknown, Record<ExtensionType, Record<CliExtensionSubcommand, ArgumentDefinitions>>>;
};
/**
