...
exports.ALL_COMMANDS = Object.values(exports.METHOD_MAP)
...
function routeToCommandName(endpoint, method, basePath) {
    ...
    let normalizedEndpoint = resolvedBasePath
        ? endpoint.replace(new RegExp(`^${support_1.util.escapeRegExp(resolvedBasePath)}`), '')
        : endpoint;
    ...
    for (const [routePath, routeSpec] of Object.entries(exports.METHOD_MAP)) {
