...
class ProtocolConverter {
    ...
    async proxySetWindow(url, method, body) {
        const bodyObj = support_1.util.safeJsonParse(body);
        if (support_1.util.isPlainObject(bodyObj)) {
            const obj = bodyObj;
            if (this.downstreamProtocol === W3C &&
    ...
    async proxySetValue(url, method, body) {
        const bodyObj = support_1.util.safeJsonParse(body);
        if (support_1.util.isPlainObject(bodyObj) &&
            (support_1.util.hasValue(bodyObj?.text) || support_1.util.hasValue(bodyObj?.value))) {
            ...
            else if (!support_1.util.hasValue(text) && support_1.util.hasValue(value)) {
    ...
    async proxySetFrame(url, method, body) {
        const bodyObj = support_1.util.safeJsonParse(body);
        if (Object.hasOwn(bodyObj ?? {}, 'id') &&
            support_1.util.isPlainObject(bodyObj.id)) {
