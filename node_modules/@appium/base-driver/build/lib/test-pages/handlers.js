...
async function guineaPigTemplate(req, res, page) {
    ...
    if (delay) {
        ...
        await (0, asyncbox_1.sleep)(delay);
    }
...
async function getTemplate(templateName) {
    const content = await support_1.fs.readFile(node_path_1.default.resolve(static_dir_1.TEST_FIXTURES_DIR, 'test', templateName));
    return (0, template_1.compileLodashTemplate)(content.toString());
}
