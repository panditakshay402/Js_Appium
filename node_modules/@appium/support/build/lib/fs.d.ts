...
import { close, constants, createReadStream, createWriteStream, promises as fsPromises, read, open, type CopyOptions, type PathLike, type MakeDirectoryOptions, type ReadAsyncOptions } from 'node:fs';
import type { GlobOptions } from 'glob';
import klaw from 'klaw';
import type { Walker } from 'klaw';
import { type NormalizeOptions, type NormalizedPackageJson } from './internal';
 ...
 */
export declare function toCpOptions(opts?: CopyFileOptions): CopyOptions;
export declare const fs: {
     ...
     */
    copyFile(source: string, destination: string, opts?: CopyFileOptions): Promise<void>;
